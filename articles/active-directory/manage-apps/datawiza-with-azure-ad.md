...
## Configure your application in Datawiza Cloud Management Console
...
3. Register the application in your Azure AD tenant by using Datawiza's convenient [one-click integration](https://docs.datawiza.com/tutorial/web-app-azure-one-click.html). 
...
If you prefer to configure this form for a web application manually, you'll need the tenant ID, client ID, and client secret. For more information about creating a web application and getting these values, see [Microsoft Azure AD in the Datawiza documentation](https://docs.datawiza.com/idp/azure.html).
...
9. Confirm that user attributes were successfully configured by observing a green check mark next to each attribute.
